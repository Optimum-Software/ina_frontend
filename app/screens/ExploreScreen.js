            ...
            {this.state.cards.map(card => {
              return (
                <TouchableWithoutFeedback
                  ...
                  onPress={() =>
                    this.state.showDetails ? null : this.animate()
                  }
                >
                    ...
                    >
                      ...
                      >
                        ...
                        <Text
                          ...
                          numberOfLines={
                            isIphoneX
                              ? (Dimensions.get("window").height - 150) / 65
                      ...
                      <Animated.View
                        style={{
                          ...
                          position: "absolute",
                          top:
                            (Dimensions.get("window").height - 90) * 0.5 - 30,
                          right: 25,
                          justifyContent: "center",
                          alignItems: "center"
                        }}
                ...
                Router.goTo(
                  ...
                  "ProjectDetailScreen",
                  {
                    ...
                    end_date: this.state.cards[this.swiper.state.sindex - 2]
                      .endDate,
                    created_at: this.state.cards[this.swiper.state.sindex - 2]
                      .createdAt,
                    like_count: this.state.cards[this.swiper.state.sindex - 2]
                      .likeCount,
                    follower_count: this.state.cards[
                      this.swiper.state.sindex - 2
                    ].followerCount,
                    location: this.state.cards[this.swiper.state.sindex - 2]
                      .location,
                    thumbnail: this.state.cards[this.swiper.state.sindex - 2]
                      .thumbnail,
                    creator: this.state.cards[this.swiper.state.sindex - 2]
                      .creator,
                    images: this.state.cards[this.swiper.state.sindex - 2]
                      .images,
                    files: this.state.cards[this.swiper.state.sindex - 2].files,
                    liked: this.state.cards[this.swiper.state.sindex - 2].liked,
                    member: this.state.cards[this.swiper.state.sindex - 2]
                      .member,
                    followed: this.state.cards[this.swiper.state.sindex - 2]
                      .followed
                  }
                )
              }
