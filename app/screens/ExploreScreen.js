              ...
              onPress={() =>
                Router.goTo(
                  ...
                  "ProjectDetailScreen",
                  {
                    ...
                    start_date: this.state.cards[this.state.cardIndex]
                      .startDate,
                    end_date: this.state.cards[this.state.cardIndex].endDate,
                    created_at: this.state.cards[this.state.cardIndex]
                      .createdAt,
                    like_count: this.state.cards[this.state.cardIndex]
                      .likeCount,
                    follower_count: this.state.cards[this.state.cardIndex]
                      .followerCount,
                    location: this.state.cards[this.state.cardIndex].location,
                    thumbnail: this.state.cards[this.state.cardIndex].thumbnail,
